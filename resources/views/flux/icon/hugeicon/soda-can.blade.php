...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M5 5L19 5" stroke="currentColor" stroke-width="1.5" />
    <path d="M5 19H19" stroke="currentColor" stroke-width="1.5" />
    <path d="M6 2H18" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
