...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    <path d="M9.00488 4.15468C8.3104 3.15451 7.15576 2.5 5.84876 2.5C3.72584 2.5 2.00488 4.22674 2.00488 6.35679C2.00488 7.65354 2.64271 8.80081 3.62076 9.5" stroke="currentColor" stroke-width="1.5" />
    ...
    <path d="M19.0049 20.5C19.263 20.5 19.9606 20.5 21.0049 20.5" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
