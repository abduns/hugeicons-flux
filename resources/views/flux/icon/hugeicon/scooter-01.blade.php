...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M5 7H9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
    <path d="M10 17C10 18.6569 8.65685 20 7 20C5.34315 20 4 18.6569 4 17" stroke="currentColor" stroke-width="1.5" />
    <circle cx="20" cy="16" r="2" stroke="currentColor" stroke-width="1.5" />
