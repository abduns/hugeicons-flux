...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M15.2207 10.686L17.3751 8.53168" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M13.375 8.84143L15.5294 6.68707" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
</svg>
@break
@endswitch
