...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M4 3H20" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M4 9H20" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M4 15H9" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
</svg>
@break
@endswitch
