...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M13 20C13 18.3453 13.3453 18 15 18H19C20.6547 18 21 18.3453 21 20C21 21.6547 20.6547 22 19 22H15C13.3453 22 13 21.6547 13 20Z" stroke="currentColor" stroke-width="1.5" />
    ...
    <path d="M17 15V18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
</svg>
@break
@endswitch
