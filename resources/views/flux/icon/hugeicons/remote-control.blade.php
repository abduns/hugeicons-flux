...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M8 15H10" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M8 18H10" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M14 15H16" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M14 18H16" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
