...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="18.5" cy="19.5" r="2.5" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5" />
    <path d="M16 7L18 8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
</svg>
@break
@endswitch
