...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M15 15C16.6569 15 18 13.6569 18 12C18 10.3431 16.6569 9 15 9" stroke="currentColor" stroke-width="1.5" />
    <path d="M15 19C18.866 19 22 15.866 22 12C22 8.13401 18.866 5 15 5" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
</svg>
@break
@endswitch
