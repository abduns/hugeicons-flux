...
<svg {{ $attributes->class($classes) }} data-flux-icon aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M2.5 13L16.5 13" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
    <path d="M2.5 17H12" stroke="currentColor" stroke-width="1.5" />
    <path d="M12 21.5L12 9" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
